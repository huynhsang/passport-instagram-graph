 ...
 *   - `accountType`      the user's account type
 *
 ...
 *
 * Because new Instagram from facebook requires `app_id` instead `client_id`.
 * Therefore, this function adds the following properties:
 *
 *  - `app_id`          the Instagram client_id.
 *
 * @param {Object} options
 * @return {Object}
 * @api protected
 ...
 *
 * Because new Instagram from facebook requires `app_id` & `app_secret` instead `client_id` & `client_secret`.
 * Therefore, this function adds the following properties:
 *
 *  - `app_id`          the Instagram client_id.
 *  - `app_secret`      the Instagram client_secret.
 *
 * @return {Object}
 * @api protected
 */
